...
export default function NotFound() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-off-white)] text-center px-6">
      <div className="max-w-lg">
        <div className="font-display font-black text-[var(--color-neutral-100)] leading-none mb-0"
        ...
        <p className="text-[var(--color-neutral-500)] mb-10 leading-relaxed">
