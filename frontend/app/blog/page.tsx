      ...
      <section className="section">
        <div className="container-site">
          ...
          <Link
            ...
            className="group block no-underline mb-16 rounded-3xl overflow-hidden bg-white border border-[var(--color-neutral-200)] card-hover"
          ...
          >
            <article className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr]">
              ...
              <div className="flex flex-col justify-center p-10 lg:p-14">
                ...
                <p className="text-[var(--color-neutral-500)] leading-relaxed mb-6">{featured.excerpt}</p>
                <div className="flex items-center gap-4 mb-6 flex-wrap">
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <div>
                      <div className="text-sm font-semibold text-[var(--color-neutral-900)]">{featured.author.name}</div>
                      <div className="text-xs text-[var(--color-neutral-400)]">{formatDate(featured.publishedAt)}</div>
                    </div>
                  </div>
                  {featured.readingTime && (
                    <div className="flex items-center gap-1.5 text-sm text-[var(--color-neutral-400)] ml-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {rest.map(post => (
              <Link
                key={post._id}
                href={`/blog/${post.slug}`}
                className="group block no-underline rounded-2xl overflow-hidden bg-white border border-[var(--color-neutral-200)] card-hover"
              ...
              >
                <article>
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-sm text-[var(--color-neutral-500)] leading-relaxed line-clamp-3">
                      {post.excerpt}
                    </p>
