      ...
      <div className="container-site">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <h2 className="heading-1 text-[var(--color-neutral-900)] mb-6">
              The EstateHaven<br />
              <em className="italic text-[var(--color-accent)]">Difference</em>
            </h2>
            <span className="divider-accent" />
            <p className="text-lg text-[var(--color-neutral-500)] leading-relaxed mt-6 mb-10">
            ...
            <div className="flex flex-col gap-6">
              {WHY_US.map(({ icon: Icon, title, description }) => (
                <div key={title} className="flex gap-4">
                  <div className="w-12 h-12 rounded-xl bg-white border border-[var(--color-neutral-200)] flex items-center justify-center shrink-0"
                    style={{ boxShadow: 'var(--shadow-card)' }}>
                    <Icon size={20} className="text-[var(--color-accent)]" />
                  </div>
                  <div>
                    <h3 className="text-base font-semibold text-[var(--color-neutral-900)] mb-1">{title}</h3>
          ...
          <div className="relative h-[560px] hidden lg:block">
            ...
            {/* Badge */}
            <div className="absolute bottom-[20%] left-[2%] bg-[var(--color-accent)] rounded-2xl px-6 py-5"
