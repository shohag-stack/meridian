...
export default function PageHeader({eyebrow,title, subtitle,path}:{eyebrow: string, title: string,subtitle: string, path: string,}) {
  return (
    <div
      className="relative bg-primary min-h-150 flex justify-center items-center overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="container-site relative z-20">
        ...
        <h1 className="heading-2 md:heading-1 text-white mb-2 max-w-2xl">{title}</h1>
